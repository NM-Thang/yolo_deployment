...
def preprocess_batch(image_paths: list[Path], input_size: tuple[int, int] = (640, 640)) -> np.ndarray:
    tensors = [preprocess_image_single(image_path, input_size=input_size) for image_path in image_paths]
