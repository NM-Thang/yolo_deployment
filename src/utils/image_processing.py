...
def preprocess_image_single(image_path: str | Path | np.ndarray, input_size: tuple = (640, 640)) -> np.ndarray:
    ...
    img_dyn = _dynamic_letterbox(img, min_size=min_size, max_size=max_size, stride=32)
